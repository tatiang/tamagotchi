// Sky Cat v4.1 — OLED Tamagotchi
//
// Note: OLED12864_I2C only supports text functions (showString, showNumber).
// All graphics use ASCII art via showString. Pixel drawing is not available
...
function renderPetScreen() {
    ...
    OLED12864_I2C.showString(5, 5, "*", 1)
...
// Fly: speed lines left, cat right, pwr bar
...
// Status: four stat bars + mood label
...
// Fish moves toward cat, cat eats it
...
// Hearts float, cat goes very happy
...
// Speed lines grow, cat zooms right
...
// Ball moves toward cat, cat bats it
...
// Show updated bars with "all +" message
...
// Top header: title left, F/J/E level chars right, divider row
...
// Text bar: # = filled, . = empty, 0–100 value scaled to width chars
...
// Single char showing stat level: # = high (≥66), . = mid (≥33), - = low
...
// Bottom caption for pet screen based on current mood
